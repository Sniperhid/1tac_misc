class CfgLoadouts
{
    ...
    class US_MARINES_1990_DBDU
    {
        ...
        category = "USA";
        #include "loadouts\us_marines_1990_dbdu.hpp"
    };
    class US_MARINES_2003_OIF_DCU
    {
        displayName = "US Marines (2003 OIF, DCU)";
        category = "USA";
    ...
    class US_ARMY_1945
    {
        ...
        #include "loadouts\us_army_1945.hpp"
    };
    class US_MARINES_1945
    {
        displayName = "US Marines (1945, Duck Hunter)";
        category = "World War 2";
        #include "loadouts\us_marines_1945.hpp"
    };
    class WEHRMACHT_1945
    {
        displayName = "Wehrmacht (1945)";
        category = "World War 2";
