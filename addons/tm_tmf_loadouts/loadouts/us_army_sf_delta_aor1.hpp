...
tooltip = "Author: Bear\n\nHigh speed, low drag, giga operator\nUS Army SFOD-D/Delta Force/CAG in AOR1";

class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {
        "bear_uniform_g3_aor1_us",
        "bear_uniform_g3_aor1_us",
        "bear_uniform_g3_aor1_us",
        "bear_uniform_g3_aor1_multicam_us"
    };
    vest[] = {};
    backpack[] = {};
    headgear[] = {};
...
class m : car
{
    displayName = "Medic";
    uniform[] = {
        "bear_uniform_g3_aor1_med",
        "bear_uniform_g3_aor1_med",
        "bear_uniform_g3_aor1_med",
        "bear_uniform_g3_aor1_medic",
        "bear_uniform_g3_aor1_medic",
        "bear_uniform_g3_aor1_medic",
        "bear_uniform_g3_aor1_multicam_med",
        "bear_uniform_g3_aor1_multicam_medic"
    };
...
class fac : co
{
    ...
    uniform[] = {
        "bear_uniform_g3_aor1_cct",
        "bear_uniform_g3_aor1_cct",
        "bear_uniform_g3_aor1_cct",
        "bear_uniform_g3_aor1_multicam_cct"
    };
    backpackItems[] = {};
    linkedItems[] = {
        "ItemMap",
...
class eng : car
{
    ...
    uniform[] = {
        "bear_uniform_g3_aor1_eod",
        "bear_uniform_g3_aor1_eod",
        "bear_uniform_g3_aor1_eod",
        "bear_uniform_g3_aor1_multicam_eod"
    };
    backpack[] = {"B_Carryall_oli"};
    magazines[] =
    {
