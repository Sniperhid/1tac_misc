...
class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"bear_uniform_indep_cadpat_ar"};
    vest[] = {};
...
class r : baseMan
{
    ...
    headgear[] = {"bear_lwh_cadpat_ar","bear_lwh_cadpat_ar_ess","bear_lwh_cadpat_ar_headset"};
    vest[] = {"bear_otv_tan"};
...
{
    displayName = "Sniper";
    headgear[] = {"usm_bdu_boonie_tan","rhsusf_bowman_cap","rhsusf_Bowman"};
    goggles[] = {};
