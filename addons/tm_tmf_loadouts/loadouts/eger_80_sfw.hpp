tooltip = "East Germany 1980s Special Forces Winter. Author: Toiton. See bottom of classlist for extra classes";
...
class baseMan {// Weaponless baseclass
    ...
    headgear[] = {"gm_gc_headgear_beret_blk","gm_gc_headgear_beret_str"};
    goggles[] = {};
    hmd[] = {};
...
class shock : r
{
    ...
    magazines[] =
    {
        LIST_10("gm_25Rnd_9x18mm_B_pst_pm63_blk"),
        LIST_2("gm_handgrenade_frag_rgd5"),
        LIST_2("gm_smokeshell_wht_gc")
    };
}