...
class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
 	uniform[] = {"CUP_U_B_BDUv2_gloves_dirty_Winter","CUP_U_B_BDUv2_gloves_dirty_Winter_M81","CUP_U_B_BDUv2_gloves_dirty_Winter"};
   	vest[] = {"usm_vest_pasgt_lbe_rm2","usm_vest_pasgt_lbe_rmpr","CUP_V_B_PASGT_winter"};
   	backpack[] = {"B_simc_USMC65_M41_M43_roll2","B_simc_USMC65_M41_Roll"};
   	headgear[] = {"rhsgref_helmet_M1_liner","gm_dk_headgear_m52_net_win"};
