...
tooltip = "Author: Bear\n\nMimics my RACS faction. From the southern half of Sahrani. 5.56 mm rifles.";
//Compatible with ACE Advanced Medical

class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"bear_uniform_vkbo_racs"};
    vest[] = {};
    backpack[] = {};
    headgear[] = {};
    goggles[] = {"default"};
...
class r : baseMan
{
    ...
    primaryWeapon[] = {"CUP_arifle_Galil_black"};
    scope[] = {"cup_optic_aimpoint_5000"};
    attachment[] = {};
    magazines[] =
    {
        LIST_10("tac1_tm_mag_compat_25Rnd_762x51_Galil_M80"),
        LIST_2("rhs_mag_m67"),
