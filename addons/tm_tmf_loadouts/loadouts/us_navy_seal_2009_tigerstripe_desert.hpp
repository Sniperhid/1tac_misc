...
class r : baseMan
{
    ...
    headgear[] = {
        ...
        "tm_mich_bare_norotos_alt_desert",
        "tm_mich_bare_norotos_alt_desert_headset"
    };
    vest[] = {
...
class g : r
{
    ...
    backpack[] = {"B_Kitbag_sgg", "B_AssaultPack_cbr", "CUP_B_Bergen_BAF"};
    vest[] = {
        "CUP_V_MBSS_PACA2_Tan",
        "CUP_V_MBSS_PACA2_Tan",
        "CUP_V_MBSS_PACA2_RGR"
...
class m : car
{
    ...
    backpack[] = {"B_AssaultPack_cbr", "CUP_B_Bergen_BAF"};
    backpackItems[] = {
...
class ar : r
{
    ...
    backpack[] = {"B_Kitbag_sgg", "CUP_B_USPack_Coyote"};
