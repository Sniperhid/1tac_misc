tooltip = "West German GSG-9, 1980. Author: Käsmeister";
...
class r : baseMan
{
    ...
    vest[] = {"gm_ge_bgs_vest_type3a1_oli"};
    backpack[] = {""};
    primaryWeapon[] = {"gm_mp5a2_blk"};
    magazines[] =
    {
        LIST_9("gm_30Rnd_9x19mm_B_DM11_mp5_blk"),
...
class car : r
{
    ...
    magazines[] =
    {
        LIST_7("gm_30Rnd_9x19mm_B_DM11_mp5_blk"),
        LIST_1("gm_handgrenade_frag_dm51a1"),
...
class smg : r
{
    ...
    magazines[] =
    {
        LIST_7("gm_7rnd_12ga_hk512_pellet"),
