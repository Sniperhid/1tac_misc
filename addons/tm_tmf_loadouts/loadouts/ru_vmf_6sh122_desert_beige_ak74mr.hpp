...
tooltip = "Author: Bear\n\nLike the Russian forces seen in Syria (later). 6Sh122 oversuit and Ratnik gear. Upgraded AK-74MRs.";
...
class g : r
{
    ...
    backpack[] = {"CUP_O_RUS_Patrol_bag_BeigeDigital", "CUP_O_RUS_Patrol_bag_BeigeDigital_Shovel"};
