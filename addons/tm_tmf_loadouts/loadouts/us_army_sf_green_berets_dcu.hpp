...
class m : car
{
    displayName = "Medic";
    uniform[] = {
        "bear_uniform_g3_dcu_med",
        "bear_uniform_g3_dcu_medic"
    };
    backpackItems[] = {
...
class fac : co
{
    ...
    uniform[] = {"bear_uniform_g3_dcu_cct"};
    backpackItems[] = {};
    linkedItems[] = {
        "ItemMap",
        "ItemCompass",
...
{
    displayName = "Sniper";
    primaryWeapon[] = {"rhs_weap_XM2010_d"};
    silencer[] = {"rhsusf_acc_m2010s_d"};
...
class eng : car
{
    ...
    uniform[] = {"bear_uniform_g3_dcu_eod"};
    backpack[] = {"B_Carryall_oli"};
    magazines[] =
    {
        LIST_5("rhs_mag_30Rnd_556x45_Mk262_Stanag_Pull"),
