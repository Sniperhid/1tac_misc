tooltip = "West Germany 1980s. Author: Toiton. See bottom of classlist for extra classes";
...
class car : r
{
    ...
    magazines[] =
    {
        LIST_7("gm_20Rnd_762x51mm_B_DM41_g3_blk"),
        LIST_1("gm_20Rnd_762x51mm_B_T_DM21A2_g3_blk"),
...
class sn : dm
{
    ...
    uniform[] = {"gm_ge_army_uniform_soldier_parka_80_ols"};
};
class sp : g
{
    displayName = "Spotter";
