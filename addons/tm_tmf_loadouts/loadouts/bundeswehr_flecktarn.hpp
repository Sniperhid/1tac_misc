...
class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"CUP_U_B_GER_Flecktarn_2", "CUP_U_B_GER_Flecktarn_6", "CUP_U_B_GER_Flecktarn_5", "CUP_U_B_GER_Flecktarn_1"};
    vest[] = {};
...
class r : baseMan
{
    ...
    headgear[] = {"CUP_H_Ger_M92_Cover", "CUP_H_Ger_M92_Cover_GG", "CUP_H_Ger_M92_Cover_GG_CB", "CUP_H_Ger_M92_Cover_GG_CF"};
    vest[] = {"CUP_V_B_GER_PVest_Fleck_RFL_LT"};
...
class g : r
{
    ...
    bipod[] = {};
    vest[] = {"CUP_V_B_GER_PVest_Fleck_Gren_LT"};
    magazines[] +=
    {
...
class ar : r
{
    ...
    vest[] = {"CUP_V_B_GER_PVest_Fleck_MG_LT"};
    magazines[] =
    {
