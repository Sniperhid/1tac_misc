...
tooltip = "Author: Bear\n\nHigh speed, low drag, giga operator\nUS Army SFOD-D/Delta Force/CAG in Multicam Arid";

class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"bear_uniform_g3_multicam_arid_us"};
    vest[] = {};
    backpack[] = {};
    headgear[] = {};
    goggles[] = {
...
class r : baseMan
{
    ...
    headgear[] = {
        ...
        "bear_opscore_multicam3_cover_pelt_nsw",
        "bear_opscore_multicam4_cover_pelt_nsw",
        ...
        "bear_opscore_tan_pelt",
        "bear_opscore_tan_pelt_cam",
        "bear_opscore_tan_pelt_cam",
        "bear_opscore_tan_pelt_nsw",
        "bear_opscore_tan_pelt_nsw",
        "bear_opscore_tan_pelt_nsw_cam"
    };
    vest[] = {
    ...
    bipod[] = {"rhsusf_acc_rvg_blk","rhsusf_acc_rvg_de","rhsusf_acc_tdstubby_tan","rhsusf_acc_grip3","rhsusf_acc_grip2","rhsusf_acc_grip2_tan","rhsusf_acc_grip2_tan"};
    silencer[] = {"rhsusf_acc_sfmb556","rhsusf_acc_sf3p556"};
    sidearmWeapon[] = {"rhsusf_weap_glock17g4"};
    sidearmAttachments[] = {"acc_flashlight_pistol"};
    magazines[] =
    {
        LIST_9("rhs_mag_30Rnd_556x45_Mk262_PMAG_Tan"),
...
class car : r
{
    ...
    magazines[] =
    {
        LIST_8("rhs_mag_30Rnd_556x45_Mk262_PMAG_Tan"),
        LIST_2("rhsusf_mag_17Rnd_9x19_FMJ"),
        "rhs_mag_m67",
        "rhs_mag_an_m8hc"
    };
...
class m : car
{
    displayName = "Medic";
    uniform[] = {
        "bear_uniform_g3_multicam_arid_med",
        "bear_uniform_g3_multicam_arid_medic"
    };
...
class smg : r
{
    ...
    magazines[] =
    {
        LIST_4("rhs_mag_30Rnd_556x45_Mk262_PMAG_Tan"),
        "rhs_mag_m67"
    };
};
class ftl : g
...
class co : sl
{
    ...
    magazines[] = {
        ...
        LIST_5("rhs_mag_30Rnd_556x45_Mk262_PMAG_Tan"),
...
class fac : co
{
    ...
    uniform[] = {"bear_uniform_g3_multicam_arid_cct"};
    backpackItems[] = {};
    linkedItems[] = {
        "ItemMap",
        "ItemCompass",
...
class eng : car
{
    ...
    uniform[] = {"bear_uniform_g3_multicam_arid_eod"};
    backpack[] = {"B_Carryall_oli"};
    magazines[] =
    {
        LIST_5("rhs_mag_30Rnd_556x45_Mk262_PMAG_Tan"),
