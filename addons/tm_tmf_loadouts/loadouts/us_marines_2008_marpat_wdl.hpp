...
class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"bear_uniform_FROG01_wd"};
    vest[] = {};
...
class r : baseMan
{
    ...
    headgear[] = {
        "bear_lwh_marpat_wd",
        "bear_lwh_marpat_wd_blk_ess",
        "bear_lwh_marpat_wd_headset_blk2",
        "bear_lwh_marpat_wd_headset_blk",
        "bear_lwh_marpat_wd_headset",
        "bear_lwh_marpat_wd_ess"
    };
