...
tooltip = "Author: Bear\n\nOften seen alongside US Army Green Berets";

class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {
        "bear_uniform_g3_m81_afghanistan",
        "bear_uniform_g3_m81_alt_afghanistan",
        "bear_uniform_g3_m81_alt2_afghanistan"
    };
    vest[] = {};
    ...
    insignias[] = {"tac1_tm_insignia_afghanistan_commando"};
    radios[] = {};
...
class ar : r
{
    ...
    magazines[] =
    {
        LIST_6("rhsusf_100Rnd_556x45_M855_mixed_soft_pouch"),
        "rhs_mag_m67",
        "rhs_mag_an_m8hc"
    };
};
class aar : r
{
    ...
    backpackItems[] =
    {
        LIST_4("rhsusf_100Rnd_556x45_M855_mixed_soft_pouch")
    };
    linkedItems[] += {"Binocular"};
};
class rat : car
{
    displayName = "Rifleman (RPG-7V2)";
