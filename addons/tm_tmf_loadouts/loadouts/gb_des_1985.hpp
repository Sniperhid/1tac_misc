...
class r : baseMan
{
    ...
    headgear[] = {"CUP_H_BAF_Helmet_3_DDPM","CUP_H_BAF_Helmet_4_DDPM","CUP_H_BAF_Helmet_2_DDPM","CUP_H_BAF_Helmet_1_DDPM"};
...
class ar : r
{
	...
	magazines[] =
	{
		...
		LIST_6("rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red"),
		"HandGrenade",
		"rhs_mag_an_m8hc"
	};
};
...
class sn : r
{
    ...
    headgear[] = {"CUP_H_BAF_Helmet_3_DDPM","CUP_H_BAF_Helmet_4_DDPM","CUP_H_BAF_Helmet_2_DDPM"};
    goggles[] = {"CUP_FR_NeckScarf"};
