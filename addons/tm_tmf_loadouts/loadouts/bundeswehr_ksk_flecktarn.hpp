...
class r : baseMan
{
    ...
    headgear[] = {
        "bear_opscore_flecktarn_cover_pelt_nsw",
        "bear_opscore_flecktarn_cover_pelt_nsw_cam"
    };
    ...
    silencer[] = {"cup_muzzle_snds_m16", "cup_muzzle_snds_m16_camo"};
    bipod[] = {};
    scope[] = {"rhsusf_acc_mrds"};
    attachment[] = {"cup_acc_llm01_l", "cup_acc_llm01_od_l"};
    magazines[] =
    {
