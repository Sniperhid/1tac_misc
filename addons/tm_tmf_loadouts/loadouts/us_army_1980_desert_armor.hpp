tooltip = "RHS compatible AT\nAuthor: Bear\nWith hidden armor plates.";

class baseMan {// Weaponless baseclass
    displayName = "Unarmed";
    // All randomized.
    uniform[] = {"usm_bdu_bti_des"};
    vest[] = {};
    backpack[] = {};
    headgear[] = {"usm_helmet_m1_des", "usm_helmet_m1_des", "usm_helmet_m1_des", "usm_helmet_m1_des", "usm_helmet_m1v2_des"};
    goggles[] = {};
    hmd[] = {};
...
class sl : ftl
{
    ...
    vest[] = {"tm_usm_vest_LBE_rmp_armor"};
