...
//This loadout uses the larger backpacks that would be used on long range multi day patrols
...
class r : baseMan
{
    ...
    bipod[] = {"uk3cb_underbarrel_acc_afg"};
...
class g : r
{
    ...
    primaryWeapon[] = {"UK3CB_BAF_L85A3_UGL"};
    scope[] = {"RKSL_optic_LDS"};
    attachment[] = {"UK3CB_BAF_LLM_IR_Black"};
    magazines[] +=
    {
...
class ftl : g
{
    ...
    backpack[] = {"UK3CB_BAF_B_Bergen_MTP_Radio_H_A"};
    magazines[] +=
    {
