...
class r : baseMan
{
    ...
    headgear[] = {"CUP_H_BAF_Helmet_3_dpm","CUP_H_BAF_Helmet_4_dpm","CUP_H_BAF_Helmet_2_dpm","CUP_H_BAF_Helmet_1_dpm"};
...
class sn : r
{
    ...
    headgear[] = {"CUP_H_BAF_Helmet_3_dpm","CUP_H_BAF_Helmet_4_dpm","CUP_H_BAF_Helmet_2_dpm"};
    goggles[] = {"CUP_FR_NeckScarf"};
