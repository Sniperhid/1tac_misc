...
force force ace_finger_enabled = 1;
force force ace_finger_maxRange = 5;
force force ace_overheating_unJamOnreload = 1;
force force ace_overheating_unJamFailChance = 0;
force force ace_cookoff_enable = 0;
force force ace_cookoff_enableAmmobox = 0;
force force ace_cookoff_enableAmmoCookoff = 0;
